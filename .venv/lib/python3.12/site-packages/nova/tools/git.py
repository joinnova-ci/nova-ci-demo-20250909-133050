...
class GitBranchManager:
    ...
    # Branch lifecycle
    # ---------------------------
    def create_fix_branch(self, preferred_name: Optional[str] = None) -> str:
        """Create a new fix branch and switch to it.
        If preferred_name is provided, use it; otherwise create
        nova-auto-fix/<timestamp>.
        """
        ...
        if preferred_name:
            self.branch_name = preferred_name
        else:
